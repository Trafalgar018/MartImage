...
import static com.example.trafalgar.martimage.SearchActivity.FLICKR_QUERY;
...
public class MainActivity extends BaseActivity {
    ...
    private NasaRecyclerViewAdapter mNasaRecyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNasaRecyclerViewAdapter = new NasaRecyclerViewAdapter(
                MainActivity.this,
                new ArrayList<Photo>()
        );
        mRecyclerView.setAdapter(mNasaRecyclerViewAdapter);
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(
                ...
                new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        intent.putExtra(
                                PHOTO_TRANSFER,
                                mNasaRecyclerViewAdapter.getPhoto(position)
                        );
    ...
    public class ProcessPhotos extends GetNasaData {
        ...
        public class ProcessData extends DownloadJsonData {
            ...
            protected void onPostExecute(String webData) {
                ...
                mNasaRecyclerViewAdapter.loadNewData(getPhotos());
            }
        }
    }
